...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	 ...
	 * @see azblog.ModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getBlog_Tags() {
	 ...
	 * @generated
	 */
	public EAttribute getBlog_BaseURL() {
		return (EAttribute)blogEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getBlog_Name() {
		return (EAttribute)blogEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getBlog_Autores() {
		return (EReference)blogEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getBlog_DefaultAuthor() {
		return (EReference)blogEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getPost_HtmlContent() {
	 ...
	 * @generated
	 */
	public EAttribute getComment_HtmlContent() {
	...
	public void createPackageContents() {
		...
		createEReference(blogEClass, BLOG__TAGS);
		createEReference(blogEClass, BLOG__POSTS);
		createEAttribute(blogEClass, BLOG__BASE_URL);
		createEAttribute(blogEClass, BLOG__NAME);
		createEReference(blogEClass, BLOG__AUTORES);
		createEReference(blogEClass, BLOG__DEFAULT_AUTHOR);
		...
		createEAttribute(postEClass, POST__HTML_CONTENT);
		...
		createEAttribute(commentEClass, COMMENT__HTML_CONTENT);
	...
	public void initializePackageContents() {
		...
		initEReference(getBlog_Tags(), this.getTag(), null, "tags", null, 0, -1, Blog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getBlog_BaseURL(), ecorePackage.getEString(), "baseURL", null, 0, 1, Blog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBlog_Name(), ecorePackage.getEString(), "name", null, 0, 1, Blog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBlog_Autores(), this.getAuthor(), null, "autores", null, 0, -1, Blog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBlog_DefaultAuthor(), this.getAuthor(), null, "defaultAuthor", null, 0, 1, Blog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(postEClass, Post.class, "Post", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPost_Date(), ecorePackage.getEDate(), "date", null, 0, 1, Post.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPost_HtmlContent(), ecorePackage.getEString(), "htmlContent", null, 0, 1, Post.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getComment_HtmlContent(), ecorePackage.getEString(), "htmlContent", null, 0, 1, Comment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
